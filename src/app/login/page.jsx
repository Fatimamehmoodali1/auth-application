    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-indigo-100 to-blue-200 flex items-center justify-center px-4 py-8">
      ...
      >
        ...
        <input
          ...
          required
          className="w-full border border-indigo-300 p-4 rounded-xl text-lg bg-indigo-50 placeholder:text-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-400"
        />
